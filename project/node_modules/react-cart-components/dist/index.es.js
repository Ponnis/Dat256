...
var formatPrice = function formatPrice(price, currencySymbol) {
...
var Thumb = function Thumb(props) {
  return React.createElement(
    ...
    React.createElement('img', { src: props.src, alt: props.alt, title: props.title })
  );
};
  ...
  createClass(Cart, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          currencySymbol = _props.currencySymbol,
          checkoutLabel = _props.checkoutLabel;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            products,
            cartProducts === undefined || cartProducts.length == 0 && React.createElement(
              "p",
...
var index$1 = connect(mapStateToProps, mapDispatchToProps$1)(Cart);
...
export { index as AddCartButton, index$1 as Cart, reducers as CartReducers };
